...
function createMoviesPage() {
   ...
   createInput('Search for movies');
   showSearchResultsByType('Movie', 'movies');
   ...
   document.querySelector('.main').append(moviesEl);

   getDataForMovies();

   async function getDataForMovies() {
      try {
         ...
         if (movie.category === 'Movie') {
            ...
            <div class="card-wrapper">
               <div class="card card--sm" data-id=${movie.id}>
                  <div class="card__bookmark card__bookmark--sm${dataMovies && dataMovies.includes(movie.id) ? ' bookmarked' : ''}">
            ...
            `;
            document.querySelector('.movies__cards').insertAdjacentHTML('beforeend', moviesCard);
         }
      });
   }
